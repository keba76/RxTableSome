...
class Example3Randomize: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let randomSections = Observable.of(Observable.of(()), refreshButton.rx.tap.asObservable())
            .merge()
